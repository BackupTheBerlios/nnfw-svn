...
public:
    ...
    typedef enum { t_null=0, t_double, t_int, t_uint, t_char, t_uchar, t_bool, t_string,
                t_doublevec, t_doublemat, t_outfunction, t_cluster, t_linker, t_propertized,
				t_dataptr } types;
...
public:
    ...
    virtual bool set( unsigned int i, const Variant& data ) = 0;
    /*! Return the i-th value of Vector property */
    virtual Variant get( unsigned int i ) const = 0;
...
public:
    ...
    virtual bool set( unsigned int, const Variant& ) {
        return false;
    };
    /*! It always return a Null Variant */
    virtual Variant get( unsigned int ) const {
        return Variant();
    };
...
public:
    ...
    //@{
    /*! Constructor */
    VectorPropertyAccess( const char* name, Variant::types t, T* o, Variant (T::*g)(unsigned int), bool (T::*s)(unsigned int, const Variant&) = 0 )
        : AbstractPropertyAccess( name ) {
        typep = t;
        obj = o;
        vectorv = true;
    ...
    /*! return the value of property */
    virtual Variant get( unsigned int i ) const {
        return (obj->*getPtm)(i);
    };
    /*! set the property
     *  \warning It doesn't check is the property is writable or not; before calling this
	 *  method check if the property is writable via isWritable() method
     */
    virtual bool set( unsigned int i, const Variant& data ) {
...
private:
    T* obj;
    bool (T::*setPtm)( unsigned int i, const Variant& );
    Variant (T::*getPtm)( unsigned int i );
};
...
public:
     ...
     */
    template<class T>
    void addVectorProperty( const char* name, Variant::types t, T* obj, Variant (T::*read)(unsigned int i), bool (T::*write)(unsigned int i, const Variant&) = 0 ) {
     ...
     */
    bool setVectorProperty( const char* name, unsigned int i, const Variant& data ) {
        if ( props.count( name ) == 0 ) return false;
        AbstractPropertyAccess& p = *(props[name]);
